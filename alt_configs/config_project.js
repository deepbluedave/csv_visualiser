...
let defaultConfig = {
  "configVersion": 1.9, // Incremented version
  ...
  "viewSettings": {
    ...
    "cardLinkColumn": "LinkToTask", // Link card titles to the task detail URL
    ...
    "tableView": {
      ...
      "displayColumns": [
        ...
        "DueDate",
        "EffortEst(h)",
        "LinkToTask" // Include link column
      ]
    },
    ...
    "kanbanView": {
      ...
      "cardIndicatorColumns": ["Project", "Assignee", "Status", "Priority", "DueDate", "EffortEst(h)"],
    ...
    "summaryView": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "title": "🔥 High Priority (Not Complete)", // Filter out completed high-priority tasks if needed (requires more complex logic not built-in)
  ...
  "indicatorStyles": {
    // Define styles for columns used as indicators or in table/counts view
      ...
      "LinkToTask": { // No specific indicator style needed, handled by table/card link logic
